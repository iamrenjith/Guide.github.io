d3.parcoords = function(config) {
  var __ = {
    ...
    width: 1500,
    height: 2000,
    margin: { top: 100, right: 10, bottom: 24, left: 10 },
    nullValueSeparator: "top", // set to "top" or "bottom"
    nullValueSeparatorPadding: { top: 90, right: 0, bottom: 0, left: 0 },
    color: "white",
...
pc.applyDimensionDefaults = function(dims) {
  ...
  dims.forEach(function(k) {
    ...
    newDims[k].ticks= newDims[k].ticks != null ? newDims[k].ticks : 6;
    ...
    newDims[k].tickPadding= newDims[k].tickPadding != null ? newDims[k].tickPadding : 4;
...
d3.rebind(pc, axis, "ticks", "orient", "tickValues", "tickSubdivide", "tickSize", "tickPadding", "tickFormat","wrap");
...
function flipAxisAndUpdatePCP(dimension) {
  ...
  d3.select(this.parentElement)
    .transition()
      ...
      .call(axis.tickFormat(__.dimensions[dimension].wrap));
...
function rotateLabels() {
  ...
  pc.svg.selectAll("text.label").call(wrap)
